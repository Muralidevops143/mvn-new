...
public class y extends AbstractLanguageAnalyser {
  ...
  /**
   * Execute this g over the current document.
  ...
  public void execute() throws ExecutionException {
    ...
    // long.
    if(isInterrupted()) {
      throw new ExecutionInterruptedException("Execution of g has been interrupted!");
    }
    interrupted = false;
